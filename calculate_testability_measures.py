...
def calculateTestabilityMeasures(inputFileName, outputFileName):
    ...
    saveResultToFile(outputFileName, circuitDescription, testability, sortedTest0[0:int(tenPercentSize)], sortedTest1[0:int(tenPercentSize)])
...
if __name__ == '__main__':
    ...
    parser.add_argument("-i ", "--InputFileName", help="The name of the bench format file that describes the circuit",
                        type=str, required=True)
    parser.add_argument("-o ", "--OutputFileName", help="The name of the file to export the result to",
                        type=str, required=True)
